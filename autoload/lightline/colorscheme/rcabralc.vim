...
let s:normal0  = g:rcabralc#palette.lime0
let s:normal   = g:rcabralc#palette.lime
let s:insert0  = g:rcabralc#palette.magenta0
let s:insert   = g:rcabralc#palette.magenta
let s:replace0 = g:rcabralc#palette.orange0
let s:replace  = g:rcabralc#palette.orange
let s:visual0  = g:rcabralc#palette.purple0
let s:visual   = g:rcabralc#palette.purple
let s:error    = g:rcabralc#palette.magenta
...
let s:tabsel   = g:rcabralc#palette.lime
