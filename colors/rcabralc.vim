...
if s:is_dark
    let s:magenta = s:color(s:basemagenta, { 'term': 9 })
    ...
    let s:magenta = s:blend(s:color(s:basemagenta), s:black, 1.0, { 'term': 1 })
...
let s:altmagenta = s:blend(s:magenta, s:opaquebg, 0.8, { 'term': s:is_dark ? 1 : 9 })
...
let s:altmagenta2 = s:blend(s:magenta, s:opaquebg, 0.4)
...
let s:magentabg = s:blend(s:magenta, s:opaquebg, 0.15)
...
let g:rcabralc#palette.altmagenta = s:altmagenta
...
let g:rcabralc#palette.altmagenta2 = s:altmagenta2
...
call s:hl('DiffChange', s:none, s:yellowbg)
