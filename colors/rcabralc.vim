...
call s:hl('Visual', s:none, s:purple3.actual)
...
if has('gui_running')
    call s:hl('SpellBad', s:none, s:gray3.actual, 'undercurl', 'NONE', s:red0.actual)
    ...
    call s:hl('SpellBad', s:none, s:red3.actual, 'underline', 'NONE', s:red0.actual)
    call s:hl('SpellCap', s:none, s:pink3.actual, 'underline', 'NONE', s:pink0.actual)
    call s:hl('SpellRare', s:none, s:none, 'underline', 'NONE', s:fg.actual)
    call s:hl('SpellLocal', s:none, s:orange3.actual, 'underline', 'NONE', s:orange0.actual)
endif
